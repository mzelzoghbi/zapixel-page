...
export default function PrivacyPolicy() {
  return (
    <div className="min-h-screen bg-black text-gray-100" style={{ color: '#e5e5e5' }}>
      <header className="border-b border-white/10 bg-gradient-to-b from-gray-950 to-black">
        <div className="max-w-5xl mx-auto px-6 py-10">
          <div className="text-sm text-purple-300 mb-3">ZaPixel</div>
          <h1 className="text-4xl font-semibold mb-3 text-white">Privacy Policy</h1>
          <p className="text-sm text-gray-300">Last updated: February 20, 2025</p>
        </div>
      </header>

      <main className="max-w-5xl mx-auto px-6 py-12">
        <div className="rounded-3xl border border-white/10 bg-gradient-to-b from-gray-950/70 via-black to-black shadow-[0_40px_120px_rgba(0,0,0,0.35)] p-8 md:p-12 space-y-12">
          ...
          <section className="space-y-3 leading-relaxed">
            ...
            <h3 className="text-xl font-semibold pt-2 text-white">Definitions</h3>
            ...
            <ul className="list-disc pl-6 space-y-2 text-gray-200">
              ...
              <li>
                <strong>Application</strong> refers to ZaPixel, the software program provided by the Company.
              </li>
              <li>
          ...
          <section className="space-y-4 leading-relaxed">
            <h2 className="text-2xl font-semibold text-white">Collecting and Using Your Personal Data</h2>
          ...
          <section className="space-y-3 leading-relaxed">
            <h3 className="text-xl font-semibold text-white">Use of Your Personal Data</h3>
          ...
          <section className="space-y-3 leading-relaxed">
            <h3 className="text-xl font-semibold text-white">Retention of Your Personal Data</h3>
            <p className="text-gray-200">
          ...
          <section className="space-y-3 leading-relaxed">
            <h3 className="text-xl font-semibold text-white">Transfer of Your Personal Data</h3>
            <p className="text-gray-200">
          ...
          <section className="space-y-3 leading-relaxed">
            <h3 className="text-xl font-semibold text-white">Delete Your Personal Data</h3>
            <p className="text-gray-200">
          ...
          <section className="space-y-3 leading-relaxed">
            <h3 className="text-xl font-semibold text-white">Disclosure of Your Personal Data</h3>
            <h4 className="text-lg font-semibold text-white">Business Transactions</h4>
            <p className="text-gray-200">
            ...
            <h4 className="text-lg font-semibold text-white">Law enforcement</h4>
            <p className="text-gray-200">
            ...
            <h4 className="text-lg font-semibold text-white">Other legal requirements</h4>
            <p className="text-gray-200">
          ...
          <section className="space-y-3 leading-relaxed">
            <h3 className="text-xl font-semibold text-white">Security of Your Personal Data</h3>
            <p className="text-gray-200">
          ...
          <section className="space-y-3 leading-relaxed">
            <h2 className="text-2xl font-semibold text-white">Links to Other Websites</h2>
            <p className="text-gray-200">
          ...
          <section className="space-y-3 leading-relaxed">
            ...
            <ul className="list-disc pl-6 text-gray-200">
              <li>By email: zaplatform@gmail.com</li>
            </ul>
          </section>
        </div>
      </main>
